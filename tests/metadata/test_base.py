...
def test_metadata_result_optional_fields():
...
def test_metadata_provider_abstract_methods():
...
def test_metadata_manager_registration(
    metadata_manager: MetadataManager, mock_provider: MetadataProvider
):
