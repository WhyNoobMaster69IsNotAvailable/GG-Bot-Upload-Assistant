...
def test_init_qbit(mocker):
    ...
    assert transmission.dynamic_tracker_selection is False
    assert transmission.target_label == "GG_BOT_TEST_LABEL"
    assert transmission.seed_label == "GG_BOT_CROSS_SEED_TEST"
...
def test_init_qbit_dynamic_reuploader(mocker):
    ...
    assert transmission.dynamic_tracker_selection is True
    assert transmission.target_label == "GGBOT"
    assert transmission.seed_label == "GG_BOT_CROSS_SEED_TEST"
    assert transmission.source_label == "GG_BOT_CROSS_SEED_TEST_Source"
