...
class TestMiscellaneousUtils:
    ...
    def test_miscellaneous_identify_bluray_edition(self, input, expected):
        assert MiscellaneousUtils.identify_bluray_edition(input) == expected
    ...
    def test_miscellaneous_identify_repacks(self, input, expected):
        assert MiscellaneousUtils.identify_repacks(input) == expected
    ...
    def test_detect_anamorphic_video_and_pixel_ratio(self, video_track, expected):
        (
            anamorphic_video,
            pixel_aspect_ratio,
        ) = MiscellaneousUtils.detect_anamorphic_video_and_pixel_ratio(video_track)
