...
class FakeMediaInfoVideoTrack:
    def __init__(self, pixel_aspect_ratio: str):
        self.pixel_aspect_ratio: str = pixel_aspect_ratio
...
def test_miscellaneous_perform_scene_group_capitalization(
    ...
    assert (
        miscellaneous_perform_scene_group_capitalization(
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "Crank.Extended.Version.2006.MULTi.COMPLETE.BLURAY.iNTERNAL-LiEFERDiENST",
            "Extended Version",
            id="extended_version",
        ),
        pytest.param(
            "Halloween.Kills.2021.EXTENDED.2160p.BluRay.HEVC.TrueHD.7.1.Atmos-MT",
            None,
            id="extended_all_caps_failure",
        ),
        pytest.param(
            "Perfect Blue 1997 Ultimate Edition 1080p GBR Blu-ray AVC DTS-HD MA 5.1",
            "Ultimate Edition",
            id="ultimate_edition",
        ),
        pytest.param(
            "The Breaking Point 1950 1080p Criterion Blu-ray AVC LPCM 1.0",
            "Criterion",
            id="criterion",
        ),
        pytest.param(
            "Phenomena 1985 International Cut 1080p GER Blu-ray AVC DTS-HD MA 5.1-UNTOUCHED",
            "International Cut",
            id="international_1",
        ),
        pytest.param(
            "The.NeverEnding.Story.1984.International.Cut.1080p.Blu-ray.AVC.DTS-HD.MA.5.1-BeyondHD",
            "International Cut",
            id="international_2",
        ),
        pytest.param(
            "The.Admiral.Roaring.Currents.2014.Theatrical.Cut.MULTi.COMPLETE.GER.BLURAY-Psaro",
            "Theatrical Cut",
            id="theatrical",
        ),
        pytest.param(
            "Ismael’s Ghosts 2017 Director's Cut 1080p GBR Blu-ray AVC DTS-HD MA 5.1-UNRELiABLE",
            "Director's Cut",
            id="directors_1",
        ),
        pytest.param(
            " The Outpost (2020) US Director's Cut UHD BD66 Blu-ray WiLDCAT",
            "Director's Cut",
            id="directors_2",
        ),
        pytest.param(
            "Ismaels.Ghosts.2017.DC.COMPLETE.BLURAY-UNRELiABLE",
            None,
            id="directors_failure_1",
        ),
        pytest.param(
            "The.Last.of.the.Mohicans.DiRECTORS.DEFiNiTiVE.CUT.1992.MULTi.COMPLETE.BLURAY-OLDHAM",
            None,
            id="directors_failure_2",
        ),
        pytest.param(
            "The.Wicker.Man.1973.Final.Cut.MULTi.COMPLETE.BLURAY-SAVASTANOS",
            "Final Cut",
            id="final",
        ),
    ],
...
def test_miscellaneous_identify_bluray_disc_type(
    ...
    assert (
        miscellaneous_identify_bluray_disc_type(screen_size, "", test_size)
        == expected
    )
...
def test_miscellaneous_identify_web_streaming_source(
    ...
    assert (
        miscellaneous_identify_web_streaming_source(
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "Step.Up.All.In.2014.BluRay.1080p.TrueHD.Atmos.7.1.AVC.REMUX-FraMeSToR.mkv",
            "bluray_remux",
        ),
        pytest.param(
            "Ford.v.Ferrari.2019.UHD.BluRay.2160p.TrueHD.Atmos.7.1.DV.HEVC.HYBRID.REMUX-FraMeSToR.mkv",
            "bluray_remux",
        ),
        pytest.param(
            "ZERV - Zeit der Abrechnung AKA Divided We Stand S01 1080p Bluray REMUX AVC DTS-HD MA 2.0-KKdL",
            "bluray_remux",
        ),
        pytest.param(
            "Bran.Nue.Dae.2009.1080p.BluRay.REMUX.AVC.TrueHD.5.1-BLURANiUM.mkv",
            "bluray_remux",
        ),
        pytest.param(
            "The Warriors 1979 Theatrical Cut 1080p AUS Blu-ray AVC DTS-HD MA 5.1-CultFilms™",
            "bluray_disc",
        ),
        pytest.param(
            "Flirting in the Air 2014 BluRay 1080p AVC TrueHD 5.1-ADC",
            "bluray_disc",
        ),
        pytest.param(
            "Legendary Weapons of China AKA Shi ba ban wu yi 1982 1080p GBR Blu-ray AVC LPCM 2.0-HGN",
            "bluray_disc",
        ),
        pytest.param(
            "Flossie 1974 / Keep It Up, Jack! 1974 1080p Blu-ray AVC DTS-HD MA 2.0-GSeye",
            "bluray_disc",
        ),
        pytest.param(
            "My.Little.Chickadee.1940.Mae.West.1982.COMPLETE.BLURAY-INCUBO",
            "bluray_disc",
        ),
        pytest.param(
        ...
        pytest.param(
            "Vanity Fair (2018) S01E01 2160p HDR Amazon WEBRip DD+ 5.1 x265-TrollUHD.mkv",
            "webrip",
        ),
        pytest.param(
            "Our.Planet.2019.S01E01.One.Planet.1080p.NF.WEBRip.DDP5.1.x264-NTb.mkv",
            "webrip",
        ),
        pytest.param(
        ...
        pytest.param(
            "Dancing.with.the.Birds.2019.2160p.NF.WEBRip.DDP5.1.x265-TOMMY.mkv",
            "webrip",
        ),
        pytest.param(
            "American.Driver.2017.1080p.AMZN.WEB-DL.DDP2.0.H.264-SiGLA.mkv",
            "webdl",
        ),
        pytest.param(
            "Tehran.S02E02.Change.of.Plan.2160p.ATVP.WEB-DL.DDP5.1.HDR.H.265-NTb.mkv",
            "webdl",
        ),
        pytest.param(
            "Conversations with Friends S01 1080p HULU WEB-DL DD+ 5.1 H.264-MiON",
            "webdl",
        ),
        pytest.param(
            "Kajillionaire.2020.2160p.AMZN.WEB-DL.DDP.5.1.HDR10Plus.HEVC-MiON.mkv",
            "webdl",
        ),
        pytest.param(
            "5 Centimeters Per Second [2007] 1080p ITA BDRip x265 DTS-HD MA 5.1 Kira [SEV].mkv",
            "bluray_encode",
        ),
        pytest.param(
        ...
        pytest.param(
            "Birthday.Wonderland.2019.1080p.BluRay.x264.DTS.mkv",
            "bluray_encode",
        ),
        pytest.param(
            "Gruppo.di.famiglia.in.un.interno.VOSTFR.1974.1080p.Bluray.Flac.2.0.x264-KINeMA.mkv",
            "bluray_encode",
        ),
        pytest.param(
            "They Call Me Trinity AKA Lo chiamavano Trinita... 1970 PAL DVD9 DD 2.0",
            "dvd",
        ),
        pytest.param(
            "Only.Fools.And.Horses.S01E01.Big.Brother.PAL.DVD.MPEG-2.DD2.0.REMUX.mkv",
            "dvd",
        ),
        pytest.param(
            "20000.Leagues.Under.the.Sea.2004.NTSC.DVD.REMUX.DD.2.0-NEMO.mkv",
            "dvd",
        ),
        pytest.param(
            "G.I.Joe.S03E01.Operation.Dragonfire.Day.1.480i.NTSC.DVD.REMUX.DD.2.0-ATELiER.mkv",
            "dvd",
        ),
        pytest.param("The Prototype 2022 NTSC DVD5 DD 5.1-CONSORTiUM", "dvd"),
        pytest.param(
            "The.Most.Courageous.Raid.of.World.War.II.2019.1080p.HDTV.H264-UNDERBELLY.mkv",
            "hdtv",
        ),
        pytest.param(
        ...
        pytest.param(
            "The.94th.Annual.Academy.Awards.2022.1080p.HDTV.x264-DARKFLiX.mkv",
            "hdtv",
        ),
        pytest.param("Jeopardy.2017.12.01.720p.HDTV.x264-NTb.mkv", "hdtv"),
        pytest.param(
            "The.Piano.Tuner.Of.Earthquakes.2005.720p.HDTV.x264-CBFM.mkv",
            "hdtv",
        ),
        pytest.param(
            "Knives.Out.2019.REMUX.1080p.Blu-ray.AVC.Atmos.DTS-HD.MA.7.1-LEGi0N.mkv",
            "bluray_remux",
        ),
    ],
)
def test_miscellaneous_identify_source_type(raw_file_name, expected):
    assert (
        miscellaneous_identify_source_type(raw_file_name, True, None)
        == expected
    )
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "ko",
            _get_media_info_audio_tracks(
                f"{working_folder}{mediainfo_xml}Squid.Game.S01E01.Red.Light.Green.Light.2160p.NF.WEB-DL.DV.HDR.DDP5.1.Atmos.H.265-RG.xml"
            ),
        ...
        pytest.param(
            "te",
            _get_media_info_audio_tracks(
                f"{working_folder}{mediainfo_xml}Sita.Ramam.2022.1080p.AMZN.WEB-DL.Multi.DDP5.1.H.264-RG.xml"
            ),
        ...
        pytest.param(
            "en",
            _get_media_info_audio_tracks(
                f"{working_folder}{mediainfo_xml}2001.A.Space.Odyssey.1968.Hybrid.2160p.UHD.BluRay.REMUX.DV.HDR10Plus.HEVC.DTS-HD.MA.5.1-RG.xml"
            ),
        ...
        pytest.param(
            "ml",
            _get_media_info_audio_tracks(
                f"{working_folder}{mediainfo_xml}In.Harihar.Nagar.1990.1080p.DSNP.WEB-DL.AAC2.0.x264-DRG.xml"
            ),
...
def test_fill_dual_multi_and_commentary(
    ...
    dual, multi, commentary = fill_dual_multi_and_commentary(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            None,
            None,
            id="no_original_language",
        ),
        pytest.param(
            {},
            None,
            None,
            id="no_original_and_spoken_language",
        ),
    ],
)
def test_get_upload_original_language_title(
    ...
    language_str, language_str_if_foreign = get_upload_original_language_title(
        tmdb_metadata
    )
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            FakeMediaInfoVideoTrack("1.0"),
            {
                "anamorphic_video": False,
                "pixel_aspect_ratio": 1.000,
            },
            id="normal_video",
        ),
        pytest.param(
            FakeMediaInfoVideoTrack("1.0000"),
            {
                "anamorphic_video": False,
                "pixel_aspect_ratio": 1.000,
            },
        ...
        pytest.param(
            FakeMediaInfoVideoTrack("1.458"),
            {
                "anamorphic_video": True,
                "pixel_aspect_ratio": 1.458,
            },
            id="anamorphic_video",
        ),
        pytest.param(
            FakeMediaInfoVideoTrack("0.458"),
            {
                "anamorphic_video": True,
                "pixel_aspect_ratio": 0.458,
            },
            id="anamorphic_video_2",
        ),
        pytest.param(
            FakeMediaInfoVideoTrack("0.458632"),
            {
                "anamorphic_video": True,
                "pixel_aspect_ratio": 0.459,
            },
            id="anamorphic_video_3",
        ),
        pytest.param(
            FakeMediaInfoVideoTrack("0.458132"),
            {
                "anamorphic_video": True,
                "pixel_aspect_ratio": 0.458,
            },
            id="anamorphic_video_5",
        ),
        pytest.param(
            FakeMediaInfoVideoTrack("0.asd"),
            {
                "anamorphic_video": False,
                "pixel_aspect_ratio": 1.000,
            },
            id="invalid_pixel_aspect_ratio",
        ),
    ],
)
def test_detect_anamorphic_video_and_pixel_ratio(video_track, expected):
    (
        anamorphic_video,
        pixel_aspect_ratio,
    ) = detect_anamorphic_video_and_pixel_ratio(video_track)

    assert expected["anamorphic_video"] == anamorphic_video
    assert expected["pixel_aspect_ratio"] == pixel_aspect_ratio
